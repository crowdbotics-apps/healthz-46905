"""
Django settings for healthz_46905 project.
...
ROOT_URLCONF = 'healthz_46905.urls'
...
WSGI_APPLICATION = 'healthz_46905.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthz_46905 API",
    "DESCRIPTION": "API documentation for healthz_46905 App",
    "VERSION": "v1",
}
